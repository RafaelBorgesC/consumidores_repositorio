...
if st.button("Gerar Gráfico") and empresas_selecionadas:
    ...
    df_mensal = df_total_ord.groupby("Ano_Mes", observed=True)["CONSUMO_MWm"].sum().reset_index()
    ...
    media_anuais = df_mensal.groupby("Ano", observed=True)["CONSUMO_MWm"].mean().reset_index()
